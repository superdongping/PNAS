function EEG_power=freq_plot(P,duration_t)

% EEG_power=sum(P(:,start_t:end_t),2);
% plot(EEG_power)


% EEG power data could be normalized by the duration of the analysis
Norm_EEG_power=sum(P(:,1:duration_t-1),2)/duration_t;
EEG_power=Norm_EEG_power;
plot(Norm_EEG_power)

% set(gca,'ytick',[0:0.5:2]);
set(gca,'xtick',[0:1:50]);
set(gca,'LineWidth', 2);
ylabel('Normalized EEG power (a.u)','Fontsize',18);
